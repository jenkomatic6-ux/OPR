...
if "neznanec" in imenik:
    ...
    print("Ni neznanca")
#varni dostop
# slovar.get("kluč", "vrenemo če ni ključa
print(imenik.get("Ažbe","Ni Ažbeta"))
print(imenik.get("Neznanec"),0)

# iz shrech scenarija preštej pozamezne črke
scenarij= """Once upon a time there was a lovely princess. But she had an enchantment upon her of a fearful
...
#gremo cez vsecrke preevrimo ali je crka v slovarju ce je ni jo dadamo in astavimo na 1 ce pa je dodamo +1
scenarij= scenarij.upper().replace(",","").replace(".","").replace("!","").replace("?","").replace("/","").split()
crke={}
